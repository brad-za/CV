...
const About: React.FC = () => {
  return (
    ...
    >
      <img src={me} className="h-96 rounded-full shadow-lg" alt="Profile" />
      ...
      <div className="bg- w-1/3 flex-row items-center justify-center">
        ...
        <p className="py-1">
          I enjoy working on a team and learning from my peers and leaders. I
          believe I am a fast learner and I am ready to take on any challenge.
        </p>
        <h2 className="py-2 text-2xl font-semibold underline">Details</h2>
