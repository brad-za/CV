...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="group mb-8 w-full rounded-lg bg-white pb-12  text-black shadow-lg outline-yellow-400 transition duration-500 ease-in hover:-translate-y-1 hover:outline md:max-w-[650px] lg:max-w-[950px] lg:p-8">
      <Link
        to={
          language
            ? category
